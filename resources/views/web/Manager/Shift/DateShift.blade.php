...
<section class="shift-date-picker">
      ...
      <div class="calender col-12 mx-auto p-0 mt-4">
        <div
          class="header d-flex align-items-baseline justify-content-between flex-wrap col-12 py-4 px-4"
        >
          <div class="change d-flex align-items-baseline gap-3">
            <div class="d-flex align-items-baseline gap-2">
              <p style="width: 35px" class="textOne year">۱۴۰۲</p>
              <div
                class="arrow bg-light d-flex align-items-center gap-4 py-2 px-2"
              >
                <div
                  class="rightYear d-flex align-items-center justify-content-center cursor"
                >
                  <img src="{{asset('images/Frame 43 (1).svg')}}" alt="" />
                </div>
                <div
                  class="leftYear d-flex align-items-center justify-content-center cursor"
                >
            ...
            <div class="d-flex align-items-baseline gap-2">
              ...
              >
                <div
                  class="rightMonth d-flex align-items-center justify-content-center cursor"
                >
                <img src="{{asset('images/Frame 43 (1).svg')}}" alt="" />

                </div>
                <div
                  class="leftMonth d-flex align-items-center justify-content-center cursor"
                >
                <img src="{{asset('images/Frame 44 (1).svg')}}" alt="" />
        ...
        <div
          class="items py-4 px-4 pt-0 d-flex flex-column gap-4 flex-xl-row justify-content-xl-between"
        >
          <div
            class="d-flex flex-wrap flex-md-nowrap align-items-center gap-4 justify-content-md-between gap-xl-3"
          >
            <div
              class="input d-flex flex-column align-items-start col-12 col-md-5 col-xl-6"
            >
          ...
          <div class="d-flex flex-column gap-2 justify-content-lg-between">
            <div class="input d-flex align-items-center gap-1">
              ...
              <label class="label pb-0 cursor" for="check"
                >تبعیت از تعطیلات رسمی</label
              >
            </div>
            <div
            ...
            >
              <div
                class="check cursor textTwo px-3 px-xl-0 pe-xl-2 py-2 text-center"
              >
                برداشتن تیک ها
              </div>
              <div class="borderLeft"></div>
              <div
                class="DeleteCustomShift cursor textTwo px-3 px-xl-0 py-2 text-center"
              >
              ...
              <div class="borderLeft"></div>
              <div
                class="cursor boxDrops position-relative textTwo px-3 px-xl-0 ps-xl-2 py-2 text-center"
      ...
      <!-- <div class="tableCalender d-flex align-items-center pb-5">
        <div class="boxTable w-week bgWhite">
          <div
          ...
          <div
            class="contextCardCalender height px-1 d-flex flex-column align-items-center gap-3"
          >
            1
          </div>
          <div class="px-1 py-1 col-12 pb-3">
            <button
              class="button d-flex align-items-center justify-content-between col-12"
            >
              + تعریف شیفت
        ...
        <div class="boxTable w-week bgWhite">
          ...
          >
            ...
            <div class="d-flex align-items-center justify-content-center gap-2">
              <button class="paste">paste</button>
              <button class="copy">copy</button>
              <input id="numbers" type="checkbox" class="checkBox" />
              <label class="d-none" for="numbers">sd</label>
            </div>
          </div>
          <div
            class="contextCardCalender height px-1 d-flex flex-column align-items-center gap-3"
      ...
      <div class="date-picker">
        ...
        <div class="body-date-picker overflow-hidden">
...
<script>
     const ShowDate = () => {
        ...
        for (let r = 0; r < 12; r++) {
          for (
            let i = ShamsiDate.Months[r][0].ItemNumWeek;
            i < ShamsiDate.Months[r].length + ShamsiDate.Months[r][0].ItemNumWeek;
            i++
          ) {
        ...
        leftMonth.onclick = () => {
          ...
          if (translate < 1100) {
          translate += 100;
            ContainerDatePicker.style.transform = `translateX(${translate}vw)`;
          }
