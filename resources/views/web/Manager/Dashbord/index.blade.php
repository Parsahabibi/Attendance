                ...
                <div class="row g-4 d-flex flex-column flex-md-row">
                        ...
                        <div class="col-12 rounded-16 p-lg-4 p-3 bg-white">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="img-refresh" onclick="rotate()">
                                    <img src="{{ asset('./images/refresh-icon.svg') }}" alt=""
                                        role="button" />
                                </div>
                            </div>
                            <div class="overflow-x-scroll">
                                <table class="col-12">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th class="text-center text-nowrap fs-small-100 p-2 my-5 px-1">کد پرسنلی
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="">
                                                <div class="border-table my-1" style="background-color: #009ef7"></div>
                                            </td>
                                            <td class="text-center text-nowrap fs-small-100 c-gray-dark p-2 my-5">12345
                                            </td>
                                            <td class="text-center text-nowrap fs-small-100 c-gray-dark">هانیه ضرغامی
                                            </td>
                                        ...
                                        <tr>
                                            <td class="">
                                                <div class="border-table my-1" style="background-color: #50cd89">
                                                </div>
                                            </td>
                                            <td class="text-center text-nowrap fs-small-100 c-gray-dark p-2 my-5">12345
                                            </td>
                                        ...
                                        <tr>
                                            <td class="">
                                                <div class="border-table my-1" style="background-color: #ffc712">
                                                </div>
                                            </td>
                                            <td class="text-center text-nowrap fs-small-100 c-gray-dark p-2 my-5">12345
                                            </td>
                                        ...
                                        <tr>
                                            <td class="">
                                                <div class="border-table my-1" style="background-color: #f2416f">
                                                </div>
                                            </td>
                                            <td class="text-center text-nowrap fs-small-100 c-gray-dark p-2 my-5">12345
                                            </td>
                    ...
                    <div class="col-md-6 col-12 px-0">
                        <div class="col-12 rounded-16 p-lg-4 p-3 bg-white">
                            ...
                            <div class="overflow-x-scroll">
                                <table class="d-flex flex-column justify-content-strat align-items-start">
                                    <thead>
                                        <tr>
                                            <th></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="">
                                                <div class="border-table my-1" style="background-color: #009ef7">
                                                </div>
                                            </td>
